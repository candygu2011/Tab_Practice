...
- (void)layoutSubviews
{
    ...
    } else if (!self.stateHidden && self.updatedTimeHidden) {
        self.gifView.contentMode = UIViewContentModeRight;
        self.gifView.mj_w = self.mj_w * 0.5 - 5;
        self.stateLabel.mj_w = self.mj_w * 0.5 - 5;
        self.stateLabel.mj_x = self.mj_w * 0.5 + 5;
        self.stateLabel.textAlignment = NSTextAlignmentLeft;
        self.updatedTimeLabel.mj_w = self.mj_w * 0.5 - 5;
        self.updatedTimeLabel.mj_x = self.mj_w * 0.5 + 5;
        self.updatedTimeLabel.textAlignment = NSTextAlignmentLeft;
    } else {
        self.gifView.contentMode = UIViewContentModeRight;
